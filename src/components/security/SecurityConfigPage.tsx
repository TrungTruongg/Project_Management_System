    ...
    const handleSave = () => {
        try {
            ...
            if (config.lockDuration < 1 || config.lockDuration > 1440) {
                alert("The lockout time must be between 1 minute and 24 hours (1440 minutes).");
                return;
            }
                    ...
                    <Card sx={{ height: "100%" }}>
                        <CardContent>
                                ...
                                <FormControlLabel
                                    control={
                                        <Switch
                                            ...
                                            onChange={(e) =>
                                                handleChange("enableEmailNotification", e.target.checked)
                                            }
                                            color="primary"
                                        />
                                    }
                            ...
                            <Box sx={{ mb: 2 }}>
                                ...
                                >
                                    CAPTCHA verification will be required after a number of incorrect login attempts
                                </Typography>
                            ...
                            <Grid container spacing={3}>
                                <Grid size={{ xs: 12, md: 6 }}>
                                    ...
                                    <FormControl fullWidth sx={{ mb: 2 }}>
                                        ...
                                        <TextField
                                            ...
                                            disabled={!config.requireStrongPassword}
                                            InputProps={{
                                                endAdornment: (
                                                    <InputAdornment position="end">character(s)</InputAdornment>
                                                ),
                                            }}
                                ...
                                <Grid size={{ xs: 12, md: 6 }}>
                                    <Box sx={{ pl: 2 }}>
                                        <Typography
                                            variant="body2"
                                            sx={{ mb: 2, fontWeight: 500, color: "#374151" }}
                                        >
                    ...
                    >
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid size={{ xs: 12, md: 4 }}>
                                <Typography variant="body2" sx={{ color: "#6c757d" }}>
                                    ⏰ Lock time:{" "}
                                    <strong>{config.lockDuration} minutes</strong>
                                </Typography>
                            </Grid>
                            <Grid size={{ xs: 12, md: 4 }}>
                                <Typography variant="body2" sx={{ color: "#6c757d" }}>
