...
import { Box, Typography, Card, CardContent, Grid, Button, Chip, IconButton } from '@mui/material';
import { PersonAdd, Apps, Language, ArrowForward, TrendingUp } from '@mui/icons-material';
import {
  LineChart,
  Line,
  AreaChart,
