    ...
    <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
        ...
        <ClickAwayListener onClickAway={() => handleClosePopper('assignee')}>
          ...
          >
            <Box sx={{ p: 2, borderBottom: '1px solid #e0e0e0' }}>
              <Typography sx={{ fontSize: '12px', color: '#5e6c84', mb: 1 }}>Assignees</Typography>
              <TextField
                fullWidth
                size="small"
      ...
      >
        <ClickAwayListener onClickAway={() => handleClosePopper('status')}>
          ...
          >
            <Box sx={{ p: 2, borderBottom: '1px solid #e0e0e0' }}>
              <Typography sx={{ fontSize: '12px', color: '#5e6c84', mb: 1 }}>Status</Typography>
              <TextField
                fullWidth
                size="small"
      ...
      >
        <ClickAwayListener onClickAway={() => handleClosePopper('priority')}>
          ...
          >
            <Box sx={{ p: 2, borderBottom: '1px solid #e0e0e0' }}>
              <Typography sx={{ fontSize: '12px', color: '#5e6c84', mb: 1 }}>Priority</Typography>
              <TextField
                fullWidth
                size="small"
