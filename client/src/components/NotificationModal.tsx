    ...
    try {
      for (const notification of notifications) {
        try {
          ...
          await api.delete(`/notifications/delete/${notification._id}`);
          successCount++;
          ...
          {loading ? (
            ...
            <List sx={{ p: 0 }}>
              {notifications.map((notification, index) => {
                const assignedBy = users.find(u => u._id === notification.createdBy);
                return (
